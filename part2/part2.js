...
// https://math.stackexchange.com/questions/589563/find-the-circle-best-fit-to-points-as-well-as-its-least-squares-error

// average X
// average Y
// divide by num of points
// get avg center of circle


// get avg distance from center to points to get radius
...
for(let i=0; i<blueSquares.length; i++){
    matrix.push([blueSquares[i].centerOfSquare.x, blueSquares[i].centerOfSquare.y, 1.0]);
